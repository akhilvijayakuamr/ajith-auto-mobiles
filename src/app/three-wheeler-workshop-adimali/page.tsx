...
export const metadata: Metadata = {
  title: "Three Wheeler Workshop Adimali | Auto Repair | Ajith Auto Mobiles",
  description: "Top-rated three wheeler workshop in Adimali, Idukki. Professional Piaggio Ape service, Atul Auto repair, and Mahindra Alfa service at Chettikuzhy near Kootar.",
  alternates: {
    canonical: "/three-wheeler-workshop-adimali",
  },
};

export default function ThreeWheelerWorkshopAdimaliPage() {
  return (
    <>
      <Navbar />
      <main className="bg-black text-zinc-100 min-h-screen pt-28 pb-16 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <nav className="text-xs text-zinc-500 font-mono flex items-center gap-2">
            ...
            <span>/</span>
            <span className="text-orange-500">THREE WHEELER WORKSHOP ADIMALI</span>
          </nav>

          {/* Page Header */}
          <div className="space-y-4">
            <span className="text-xs uppercase font-extrabold tracking-widest text-orange-500 block">
              Adimali Area Service
            </span>
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-white tracking-tight leading-tight">
              Three Wheeler Workshop in Adimali, Kerala
            </h1>
            <h2 className="text-lg text-zinc-400 font-medium">
              അടിമാലി ത്രീ വീലർ വർക്ക്ഷോപ്പ് | Auto Rickshaw Repair Adimali
            </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 pt-4">
            ...
            <div className="lg:col-span-8 space-y-8 text-sm sm:text-base text-zinc-300 leading-relaxed">
              <section className="space-y-4">
                <p>
                  Adimali acts as the crucial gateway town to Munnar and is a primary transport junction on the National Highway 85 in Idukki, Kerala. With intense tourism, tea plantations, and local retail delivery operations, passenger auto-rickshaws and cargo loaders run constantly on hilly loops, steep ascents, and high-altitude highway roads. Driving these terrains daily accelerates wear on master brake cylinders, selector gear cables, clutch pressure plates, and leaf spring shackles. If you are looking for a trusted **Three Wheeler Workshop Adimali** or certified **Auto Rickshaw Repair Adimali**, <strong>Ajith Auto Mobiles</strong> provides high-performance servicing to keep your vehicle optimized.
                </p>
                <p>
                  While our physical garage is situated at Chettikuzhy, near Kootar, in Idukki, we serve operators throughout the district, including Adimali. We offer diagnostic checks, heavy mechanical overhauls, and stock genuine factory spare parts to ensure same-day turnaround times for drivers.
                </p>
              </section>
              ...
              <section className="p-6 rounded-xl border border-orange-500/10 bg-zinc-950/40 space-y-3">
                <h3 className="text-base font-bold text-white uppercase tracking-wider flex items-center gap-2">
                  ...
                  അടിമാലി ഓട്ടോ റിപ്പയർ (Adimali Three Wheeler Workshop)
                </h3>
                <p className="text-xs sm:text-sm text-zinc-400">
                  അടിമാലിയിലും പരിസരപ്രദേശങ്ങളിലുമുള്ള ഓട്ടോറിക്ഷകൾക്കായി അജിത് ഓട്ടോ മൊബൈൽസിൽ അത്യാധുനിക സർവീസുകൾ ലഭ്യമാണ്. ഞങ്ങളുടെ പരിചയസമ്പന്നരായ മെക്കാനിക്കുകൾ നിങ്ങളുടെ ത്രീ വീലർ വാഹനത്തിന്റെ എൻജിൻ പണികൾ, ഗിയർ ബോക്സ് തകരാറുകൾ, ബ്രേക്ക് പണികൾ എന്നിവ മികച്ച ഒറിജിനൽ സ്പെയർ പാർട്സ് ഉപയോഗിച്ച് അടിമാലിയിലെ ഡ്രൈവർമാർക്കായി ചെയ്തു നൽകുന്നു. ഞങ്ങളുടെ <strong>ത്രീ വീലർ സർവീസ്</strong>, <strong>ഓട്ടോ റിക്ഷാ റിപ്പയർ</strong> അടിമാലി മേഖലയിലെ ഏറ്റവും വിശ്വസനീയമായ ചോയിസാണ്.
                </p>
              </section>

              <section className="space-y-4">
                <h3 className="text-xl font-bold text-white tracking-tight">
                  Adimali Three Wheeler Services We Deliver
                </h3>
                <p>
                  We are fully equipped to manage complete mechanical, transmission, suspension, and electrical servicing for Piaggio Ape, Atul Auto, and Mahindra Alfa passenger and cargo models:
                </p>
              ...
              <section className="space-y-3 border-t border-white/5 pt-6">
                <h4 className="text-xs font-bold text-zinc-500 uppercase tracking-widest">
                  Serving Regions Near Adimali
                </h4>
                <div className="flex flex-wrap gap-2 text-xs">
                  {["Adimali Town", "Munnar Gateway", "Kallar", "Machiplavu", "Valara", "Chettikuzhy", "Kootar", "Nedumkandam", "Kattappana"].map((area) => (
            ...
            <div className="lg:col-span-4 space-y-6">
              ...
              <div className="rounded-xl border border-white/5 bg-zinc-950/60 p-6 space-y-6 shadow-xl relative overflow-hidden">
                ...
                <div className="space-y-3 pt-4 border-t border-white/5">
                  ...
                  <a
                    href="https://wa.me/916282771225?text=Hello%20Ajith%20Auto%20Mobiles%2C%20I%20have%20a%20three-wheeler%20service%20inquiry%20from%20Adimali."
                    target="_blank"
              ...
              <div className="rounded-xl border border-white/5 bg-zinc-950/30 p-6 space-y-4">
                ...
                <div className="space-y-3 text-xs">
                  <div>
                    <h5 className="font-semibold text-orange-500">Q. Do you service Adimali vehicles?</h5>
                    <p className="text-zinc-400 mt-1">Yes, three-wheeler drivers from Adimali choose us for major engine overhauls. Contact us to coordinate repairs.</p>
                  </div>
                  <div>
                    <h5 className="font-semibold text-orange-500">Q. Do you carry Mahindra parts?</h5>
                    <p className="text-zinc-400 mt-1">Yes, we maintain original spare parts stock for Mahindra Alfa cargo and passenger models.</p>
                  </div>
                </div>
              </div>
            </div>
